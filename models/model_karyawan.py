...
class appschef_karyawan(models.Model):
    ...
    jabatan = fields.Selection([("ceo","CEO"),("cto","CTO"),("hr","HR"),("account","Accounting"),("em","Engineer Manager"),("dev","Developer")])
    manager = fields.Many2one(comodel_name='appschef.appschef_karyawan')
    jenis_kelamin = fields.Selection([("lakilaki","Laki-laki"),("perempuan","Perempuan")])
